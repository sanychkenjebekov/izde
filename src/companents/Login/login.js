                        ...
                        <form className="login__block--price">
                            ...
                            <div className="login__block--price__form">
                                <input
                                    ...
                                    required
                                    placeholder='Email'
                                    style={{border: emailDirty && emailError ? '1px solid #f44336' : ''}}
                                />
                            ...
                            <div className="login__block--price__form">
                                <input
                                    ...
                                    style={{border: passwordDirty && passwordError ? '1px solid #f44336' : ''}}
                                />
                            ...
                            <button className='btnGoogle'><FcGoogle className='icon'/>Continue with Google</button>
                        </form>
                    </div>
                </div>
            </div>
